  ...
  return (
    <DefaultLayout>
      <div className="pt-20 flex font-sans">
        <div className="ml-24 flex-none bg-cover" style={{ width: 240, height: 340, backgroundImage: `url(${movieDetail.movieImg})` }}>

        </div>
        <div className="p-5 flex-col">
          <div className="text-base">{movieDetail.startDate}</div>
          <div className="text-3xl font-medium">{movieDetail.title}</div>
          <div className="text-base">{movieDetail.movieDuration} phút - 0 IMDB - {movieDetail.movieFormat}</div>
        </div>
        <div className="flex-col pl-80">
          <Progress strokeWidth="8" width={170} className=" right-0 flex-1" type="circle" percent={75} />
